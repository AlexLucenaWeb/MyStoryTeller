...
var forgotPassForm = document.querySelector('#forgotPass__form');
var searchForm = document.querySelector('.search__form'); //  --  Header  --
...
function delayCheck() {
  if (timedelay == 3) {
    $('#book__menu').fadeOut('slow'); // $('#book__menu').animate({left:"100px"},  );
...
function showBurger() {
  $('#book__menu').fadeIn('fast'); // $('#book__menu').animate({right:"100px"},  );
