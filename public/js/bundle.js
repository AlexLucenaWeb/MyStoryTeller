...
var signup = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(name, email, password, passwordConfirmation) {
    var res;
...
var deleteMeAcc = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
    var res;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
...
var createReview = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(rating, review, bookId) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
...
var userDetailsForm = document.querySelector('#acc-settings');
...
var forgotPassForm = document.querySelector('#forgotPass__form'); // const searchForm = document.querySelector('.search__form');

var showReviewForm = document.querySelector('#showReview-btn'); //  --  Header  --
...
$('.index').mousemove(function (e) {
  ...
  var moveY1 = e.pageY * -1 / 60;
  var moveX2 = e.pageX * -1 / 75;
  var moveY2 = e.pageY * -1 / 75;
  var moveX3 = e.pageX * -1 / 90;
  var moveY3 = e.pageY * -1 / 90;
  var moveX4 = e.pageX * -1 / 100;
  var moveY4 = e.pageY * -1 / 100;
...
function delayCheck() {
  if (timedelay == 3) {
    $('#book__menu').fadeOut('slow'); // $('#book__menu').animate({right:"-150px"}, 400 );
...
function showBurger() {
  $('#book__menu').fadeIn('fast'); // $('#book__menu').show();
...
var clicks = 0;
if ($('#tutorial')) $('#tutorial').click(function () {
  if (clicks == 0) {
